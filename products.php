                ...
                <section class="st-section">
                    <section class="nd-section">
                        <section class="rd-section">
                            <div class="you-here">
                                <p style="margin-left: 30px;">Ju jeni në &nbsp; >> &nbsp; <a id="a-here" href="products.php"> PRODUCTS</a></p>
                            </div>
                            <div>
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img src="./assets/images/Computer0.jpg" width="270"  alt="kompjuter" style="margin-bottom: 10px; ">
                                            <p style="margin-bottom: 10px; color: #888888;">Laptop Lenovo IdeaPad 5 14IIL05, 14'', Intel Core i7, 16GB RAM, 1TB SSD, Intel Iris Plus Graphics, i hirtë</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img src="./assets/images/0.jpg" width="270"  alt="kompjuter" style="margin-bottom: 10px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Laptop Apple MacBook Pro 16 Touch Bar, 16'', Intel Core i7, 16GB RAM, 512GB SSD, AMD Radeon Pro 5500M, i hirtë</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img src="./assets/images/Asus.jpg" width="250"  alt="kompjuter" style="margin-bottom: 10px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Laptop ASUS Zenbook UX425EA, 14inch, Core-i5, 512GB SSD, 8GB DRX4 RAM, i argjendtë</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img src="./assets/images/Mnitori.jpg" width="270"  alt="kompjuter" style="margin-bottom: 10px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Monitor Samsung LC49HG90DMUXEN, 49", 144Hz, hirtë, zi</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img id="foto-product-three" src="./assets/images/Karrige0.jpg" width="80px"  alt="kompjuter" style="margin-bottom: 10px; margin-left: 90px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Karrige Nitro Concepts E250, gaming, e zezë/kuqe</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img src="./assets/images/Timon.jpg" width="110"  alt="kompjuter" style="margin-bottom: 10px; margin-left: 80px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Mbajtëse për timon Thrustmaster TS-PC / T-GT / TS-XW dhe T150 Pro Racing Wheels</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 200px; padding-right: 20px;">
                                            <img id="tastiera" src="./assets/images/Tastatur.jpg" width="270"  alt="tastatur" style="margin-bottom: 10px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Tastierë CONNECT IT CI-1129, e zezë</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td  style="width: 200px; padding-right: 20px;">
                                            <img id="ora-dy-e-nates" src="./assets/images/Ore.jpg" width="200"  alt="ore" style="margin-bottom: 10px;margin-left: 30px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Orë smart GARMIN Vívoactive 4, e argjendtë/hirtë</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                        <td  style="width: 200px; padding-right: 20px;">
                                            <img id="shtepiza" src="./assets/images/shtepize.jpg" width="170"  alt="shtepize" style="margin-bottom: 10px;">
                                            <p style="margin-bottom: 10px; color: #888888;">Kompjuter CZC PC Knight GC114, Intel Core i5, 16GB DDR4, 1TB SSM, ASUS ROG-STRIX-GTX1660S-O6G</p>
                                            <a href="product.php"> Shikoni më shumë</a>
                                        </td>
                                    </tr>
                                </table>
